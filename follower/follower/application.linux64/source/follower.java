...
public class follower extends PApplet {
...
public void draw(){
  ...
  float brightest = 0;
  float darkest = 200;  
  float randValue = 1000.2f;
  int movColors[];
  movColors = new int[video.width * video.height];
...
class OutputBuffer extends PImage implements PConstants {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "follower" };
    if (passedArgs != null) {
